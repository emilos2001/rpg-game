...
public class UI {
    ...
    public void dialogueScreenWithVillager() {
        ...
        g2d.drawImage(dinCoin, 620, 590, 30, 30, null);
        g2d.drawString("X:" + gp.player.coin, 650, 620);
        for (String line : currentDialogue.split("\n")) {
            g2d.drawString(line, x, y + 120);
            y += 30;
        }
        if (spriteNum == 1) {
        ...
        if (spriteNum2 == 1) {
            g2d.drawImage(npcLeft1, 370, 780, 50, 50, null);
        }
        if (spriteNum2 == 2) {
            g2d.drawImage(npcLeft2, 370, 780, 50, 50, null);
        }
        if (calculator || gp.player.calculatorBuy == 1) {
            g2d.drawString("press  'C'  to use calculator", 520, 820);
        }
        spriteCounter2++;
    ...
    public void answers() {
        ...
        for (int i = 0; i < 3; i++) {
            int x = 75;
            int y = 710 + (i * 45);
            if (villager.options[villager.dialogueSet][villager.dialogueIndex][i] != null) {
                for (String line : villager.options[villager.dialogueSet][villager.dialogueIndex][i].split("\n")) {
                    g2d.drawString(line, x, y);
                    y += 15;
                }
            }
            if (villager.options[villager.dialogueSet][0] == null) {
                villager.dialogueSet = 0;
            }
        }
        if (Objects.equals(currentDialogue, villager.questions[0][0])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 479) {
                correctAnswers();
            }
        }
        if (Objects.equals(currentDialogue, villager.questions[0][1])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[0][2])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[0][3])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[0][4])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
            ...
            if (cursorX == 123 && cursorY == 479) {//3rd
                correctAnswers();
            }
        }
        if (Objects.equals(currentDialogue, villager.questions[1][0])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[1][1])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[1][2])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[1][3])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[1][4])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[2][0])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[2][1])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[2][2])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[2][3])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[2][4])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[3][0])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[3][1])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[3][2])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[3][3])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[3][4])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[4][0])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[4][1])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[4][2])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[4][3])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[4][4])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[5][0])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[5][1])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[5][2])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[5][3])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[5][4])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[6][0])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[6][1])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[6][2])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[6][3])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[6][4])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[7][0])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[7][1])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[7][2])) {
            if (cursorX == 123 && cursorY == 383) {
                correctAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[7][3])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
        ...
        if (Objects.equals(currentDialogue, villager.questions[7][4])) {
            if (cursorX == 123 && cursorY == 383) {
                wrongAnswers();
            }
            if (cursorX == 123 && cursorY == 431) {
    ...
    public void buy() {
        ...
        for (int i = 0; i < gp.player.inventory.size(); i++) {
            ...
            if (lantern || gp.player.lanternBuy == 1) {
        ...
        for (int i = 0; i < gp.player.inventory.size(); i++) {
            ...
            if (cursorX == 149 && cursorY == 313) {
                ...
                if (price > gp.player.coin) {
                    g2d.setColor(Color.white);
                    g2d.drawString("You don't have enough money for that item", slotsX + 355, slotsY + 230);
                } else if (calculator || gp.player.calculatorBuy == 1) {
                    g2d.setColor(Color.white);
                    g2d.drawString("You have already a calculator", slotsX + 355, slotsY + 230);
                    keys.sellBuy = false;
                } else if (keys.sellBuy) {
                    gp.player.calculatorBuy++;
    ...
    public void dialoguesScreen() {
        int x = gp.size;
        int y = gp.size * 12;
        int width = gp.size * 14;
        int height = gp.size * 4;
        g2d.setColor(new Color(26, 26, 0));
        g2d.fillRoundRect(x, y, width, height + 70, 25, 25);
        g2d.setColor(new Color(20, 82, 20));
